...
export class GlobalExceptionFilter implements ExceptionFilter<unknown> {
	private static readonly applicationErrorStatusMap: Record<string, number> = {
		...
		PAYMENT_WEBHOOK_EVENT_PAYLOAD_MISMATCH: 409,
		...
		INVALID_DEBT_AGREEMENT_QUERY: 422,
		INVALID_DEBT_AGREEMENT_PAGINATION: 422,
		COLLECTION_RULE_ATTEMPT_ALREADY_EXISTS: 409,
		INVALID_DELINQUENT_PATIENTS_REFERENCE_DATE: 422,
		INVALID_DELINQUENT_PATIENTS_PAGINATION: 422,
	};
